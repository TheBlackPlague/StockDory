...
namespace StockDory
{
    ...
    class SearchTask
    {
        ...
        void SearchSingleMoveTimeOptimization()
        {
            ...
            if (Board.ColorToMove() == White) {
                const OrderedMoveList<White, false> moves (Board, 0, Killer, History, {}, 0, ThreadId);
                moveCount = moves.Count();
            } else {
                const OrderedMoveList<Black, false> moves (Board, 0, Killer, History, {}, 0, ThreadId);
                moveCount = moves.Count();
            }
        ...
        Score PVS(const uint8_t ply, int16_t depth, Score alpha, Score beta)
        {
            ...
            MoveList moves (Board, ply, Killer, History, ttMove, staticEvaluation, ThreadId);
        ...
        Score Quiescence(const uint8_t ply, Score alpha, const Score beta)
        {
            ...
            MoveList moves (Board, ply, Killer, History, {}, ThreadId, staticEvaluation);
