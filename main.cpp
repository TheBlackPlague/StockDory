...
int main() {
    ...
    if (chessBoard.ColorToMove() == White) {
        std::pair<Move, float> result3 = engine.alphaBetaNega<White>(chessBoard, -std::numeric_limits<float>::infinity(), std::numeric_limits<float>::infinity(), 7);
        ...
        if (chessBoard.ColorToMove() == Black) {
            std::pair<Move, float> result3 = engine.alphaBetaNega<Black>(chessBoard, -std::numeric_limits<float>::infinity(), std::numeric_limits<float>::infinity(), 7);
